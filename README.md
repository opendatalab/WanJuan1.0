...
书生·万卷多模态语料库是上海人工智能实验室（上海AI实验室）联合中央广播电视总台、人民网、国家气象中心、中国科学技术信息研究所等大模型数据联盟成员，联合打造的多知识、多模态、标准化的高质量语料数据，该语料库已覆盖通用及专用领域，总量超过10TB。
...
书生·万卷1.0为书生·万卷多模态语料库的首个开源版本，包含了书生·万卷文本数据集、书生·万卷图文数据集、书生·万卷视频数据集三部分，数据总量超过1.9TB。
